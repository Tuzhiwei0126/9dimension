...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="flex flex-col items-center gap-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 w-full max-w-7xl">
              <ThreeDCardDemo 
                ...
                title="SmartStorage" 
                description="AI/HPC-optimized storage with extreme performance, limitless scalability, and financial-grade security"
              />
              <ThreeDCardDemo 
                img="/images/product2.png" 
                title="SmartStation" 
                description="Integrated AI+HPC platform for universities, empowering teaching and research with smart resource orchestration" 
              />
              <ThreeDCardDemo 
                img="/images/product1.png" 
                title="SmartScale" 
                description="Expert solutions optimizing storage and AI training efficiency to overcome performance bottlenecks."
              />
            </div>
          </div>
        </div>
      ...
      {/* About Section */}
      <section className="min-h-screen relative flex flex-col items-center justify-center py-16 overflow-hidden">
        {/* Background effects */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col gap-10 max-w-7xl mx-auto">
            <div className="mb-6 md:mb-8">
              <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 md:mb-8 text-center">
                <span className="relative inline-block">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                <div className="bg-white/40 backdrop-blur-sm rounded-xl p-4 shadow-md border border-gray-200 hover:border-blue-500/30 transition-all duration-300 flex flex-col h-full">
                  <div className="flex items-center mb-2">
                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-blue-600/20 to-blue-400/20 flex items-center justify-center border border-blue-500/20 flex-shrink-0">
                    ...
                    <h3 className="text-base md:text-lg font-bold text-gray-900 ml-3">Our Mission</h3>
                  </div>
                ...
                <div className="bg-white/40 backdrop-blur-sm rounded-xl p-4 shadow-md border border-gray-200 hover:border-purple-500/30 transition-all duration-300 flex flex-col h-full">
                  <div className="flex items-center mb-2">
                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-purple-600/20 to-purple-400/20 flex items-center justify-center border border-purple-500/20 flex-shrink-0">
                    ...
                    <h3 className="text-base md:text-lg font-bold text-gray-900 ml-3">Core Advantage</h3>
                  </div>
                  <p className="text-gray-700 leading-relaxed text-xs md:text-sm flex-grow">
                ...
                <div className="bg-white/40 backdrop-blur-sm rounded-xl p-4 shadow-md border border-gray-200 hover:border-cyan-500/30 transition-all duration-300 flex flex-col h-full">
                  <div className="flex items-center mb-2">
                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-cyan-600/20 to-cyan-400/20 flex items-center justify-center border border-cyan-500/20 flex-shrink-0">
                    ...
                    <h3 className="text-base md:text-lg font-bold text-gray-900 ml-3">Our Products</h3>
                  </div>
                  <p className="text-gray-700 leading-relaxed text-xs md:text-sm flex-grow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6 mb-4 md:mb-6">
                  ...
                  <div key={index} className="bg-white/50 backdrop-blur-md rounded-xl overflow-hidden border border-gray-200 hover:border-blue-500/50 transition-all duration-300 shadow-md h-full">
                    <div className="flex flex-col h-full">
                      ...
                      <div className="p-3 flex-grow">
                        <h3 className="text-base md:text-lg font-bold text-gray-900 mb-1">{location.city} Office</h3>
                        <p className="text-gray-700 text-xs md:text-sm">{location.address}</p>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="lg:col-span-3 bg-white/50 backdrop-blur-md rounded-xl p-4 border border-gray-200 shadow-md flex flex-col justify-center">
                <h3 className="text-base md:text-lg font-bold text-gray-900 mb-4 text-center">CONTACT US</h3>
                <div className="space-y-4">
                  <div className="flex items-center">
                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-blue-600/20 to-blue-400/20 flex items-center justify-center mr-3 border border-blue-500/20 flex-shrink-0">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 md:h-5 md:w-5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      ...
                      <a href={`tel:${companyInfo.contact.phone}`} className="text-gray-900 hover:text-blue-600 transition-colors font-medium text-xs md:text-sm">
                        {companyInfo.contact.phone}
                      </a>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-purple-600/20 to-purple-400/20 flex items-center justify-center mr-3 border border-purple-500/20 flex-shrink-0">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 md:h-5 md:w-5 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${companyInfo.contact.email}`} className="text-gray-900 hover:text-purple-600 transition-colors font-medium text-xs md:text-sm">
              ...
              <div className="lg:col-span-3 bg-white/50 backdrop-blur-md rounded-xl p-4 border border-gray-200 shadow-md flex flex-col justify-center">
                <h3 className="text-base md:text-lg font-bold text-gray-900 mb-4 text-center">FOLLOW US</h3>
                <div className="flex justify-center gap-3 md:gap-6">
                  {companyInfo.qrCodes.map((qrCode, index) => (
                    <div key={index} className="flex flex-col items-center">
                      <div className="w-16 h-16 md:w-20 md:h-20 mb-1 p-1 bg-white rounded-lg shadow-sm">
                        <Image 
                          src={qrCode.image} 
                          alt={qrCode.name} 
                          width={100} 
                      ...
                      <p className="text-xs font-medium text-gray-900">{qrCode.name}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="border-t border-gray-300/50 pt-4 mt-auto">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <div className="flex items-center mb-3 md:mb-0">
                  <Image src="/images/logo.svg" alt="jiuwei Logo" width={80} height={25} />
                  <span className="ml-2 text-gray-600 text-xs md:text-sm">© {new Date().getFullYear()} Jiuwei Technology. All rights reserved.</span>
                </div>
