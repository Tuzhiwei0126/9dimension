...
import {
  enrichTweet,
  enrichTweet as EnrichedTweetType,
  enrichTweet as TweetPropsType,
  enrichTweet as TwitterComponentsType,
} from "react-tweet";
...
/**
 * @param {Object} props
 * @param {Object} props.tweet - 增强的推文对象
 */
...
/**
 * @param {Object} props
 * @param {Object} props.tweet - 推文对象
 * @param {Object} [props.components] - Twitter组件
...
export const MagicTweet = ({
  ...
  return (
    <div
      className={cn(
        "relative flex size-full max-w-lg flex-col bg-white/30 gap-2 overflow-hidden rounded-lg border p-4 backdrop-blur-md",
        className,
      )}
      {...props}
    >
